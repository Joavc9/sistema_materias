    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" name="names" value="{{old('names',$student->names)}}" >
        ...
        <div class="col-md-6">
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" name="semester" value="{{old('semester',$student->semester)}}" >
